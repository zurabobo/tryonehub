...
export const Header: React.FC = () => {
  ...
  return (
    <header
      ...
      "
    >
      <Link to={withLocalePath("/", locale)} aria-label="Home" className="group">
        <svg
        ...
        <div className="[@media(max-width:768px)]:hidden">
          <div>
            <nav className="hidden md:flex md:gap-[14px] md:items-center md:flex-wrap">
              ...
              {!isHomePage && (
                <div
                  className="relative group hidden md:flex items-center justify-center h-[32px] cursor-pointer rounded-b-[5px] hover:bg-[#ffffff] hover:rounded-t-[5px] hover:rounded-b-[0]"
                  onMouseEnter={toggleCategories}
                  onMouseLeave={closeCategories}
                >
                  <div className="cursor-pointer text-[#E5E7EB] text-[13px] uppercase leading-none font-[mrgvlovani] font-medium px-[6px] py-0 group-hover:text-[#1E293B] group-hover:font-semibold">
      ...
      <button
        ...
        "
      >
        <span className="absolute left-[8px] right-[8px] top-[10px] h-[2px] bg-current rounded-[2px] transition-all duration-200 ease-in-out group-aria-[expanded=true]:translate-y-[8px] group-aria-[expanded=true]:rotate-45" />
        <span className="absolute left-[8px] right-[8px] top-1/2 -translate-y-1/2 h-[2px] bg-current rounded-[2px] transition-all duration-200 ease-in-out group-aria-[expanded=true]:opacity-0" />
        <span className="absolute left-[8px] right-[8px] bottom-[10px] h-[2px] bg-current rounded-[2px] transition-all duration-200 ease-in-out group-aria-[expanded=true]:-translate-y-[8px] group-aria-[expanded=true]:-rotate-45" />
      </button>
      ...
      >
        ...
        <nav className="flex flex-col gap-[4px]">
          ...
          <RouterNavLink
            ...
            `}
            id="favorites-link"
            to={withLocalePath("/favorites", locale)}
            onClick={closeMenu}
          >
          ...
          <RouterNavLink
            to={withLocalePath("/contacts", locale)}
            onClick={closeMenu}
            className={({ isActive }) => `
